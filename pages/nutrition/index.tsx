...
const Index: React.FC = () => {
  ...
  useEffect(() => {
    ...
    nutri.map((data2) => {
      ...
      hoge =
        Math.pow((virtual_fat - ideal_fat) / ideal_fat, 2) +
        Math.pow((virtual_na - ideal_na) / ideal_na, 2) +
        Math.pow((virtual_protain - ideal_protain) / ideal_protain, 2) +
        Math.pow((virtual_carb - ideal_carb) / ideal_carb, 2) +
        Math.pow((virtual_ca - ideal_ca) / ideal_ca, 2) +
        Math.pow((virtual_cal - ideal_cal) / ideal_cal, 2);
      if (norm > hoge) {
        setNorm(hoge);
